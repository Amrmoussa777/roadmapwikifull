...
import WelcomeStep from "@/components/create-roadmap/create-new-roadmap-steps/WelcomeStep";
import Image from "next/image";
import React, { useEffect, useState } from "react";
import roadmapImage from "@public/auth-left.svg";
import RoadmapNameStep from "@/components/create-roadmap/create-new-roadmap-steps/RoadmapNameStep";
import RoadmapDescriptionStep from "@/components/create-roadmap/create-new-roadmap-steps/RoadmapDescriptionStep";
